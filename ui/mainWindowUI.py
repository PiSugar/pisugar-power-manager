...
"background-image: url();")
        ...
        self.label_3.setGeometry(QtCore.QRect(330, 40, 201, 31))
...
"background-image: url();")
        ...
        self.timeEdit.setGeometry(QtCore.QRect(430, 80, 110, 22))
...
"color: rgb(173, 173, 173);")
        ...
        self.timeType = QtWidgets.QComboBox(self.centralwidget)
        self.timeType.setGeometry(QtCore.QRect(330, 80, 90, 22))
        self.timeType.setStyleSheet("background-image: url();")
        self.timeType.setObjectName("timeType")
        self.timeType.addItem("")
        self.timeType.addItem("")
        self.timeType.addItem("")
        self.timeReapeat = QtWidgets.QPushButton(self.centralwidget)
        self.timeReapeat.setGeometry(QtCore.QRect(550, 80, 91, 23))
        self.timeReapeat.setStyleSheet("background-image: url();")
        self.timeReapeat.setObjectName("timeReapeat")
        self.clockMsg = QtWidgets.QLabel(self.centralwidget)
        self.clockMsg.setGeometry(QtCore.QRect(330, 110, 391, 21))
        self.clockMsg.setStyleSheet("font: 10pt \"Lao UI\";\n"
"background-image: url();\n"
"color: rgb(173, 173, 173);")
        self.clockMsg.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.clockMsg.setObjectName("clockMsg")
        ...
        self.hostMsg.raise_()
        self.timeType.raise_()
        self.timeReapeat.raise_()
        self.clockMsg.raise_()
        ...
        self.menuRTC = QtWidgets.QMenu(self.menubar)
        self.menuRTC.setObjectName("menuRTC")
        ...
        self.actionRTC_Time = QtWidgets.QAction(MainWindow)
        self.actionRTC_Time.setEnabled(False)
        self.actionRTC_Time.setObjectName("actionRTC_Time")
        self.actionSync_Time_Pi_to_RTC = QtWidgets.QAction(MainWindow)
        self.actionSync_Time_Pi_to_RTC.setObjectName("actionSync_Time_Pi_to_RTC")
        self.actionSync_Time_RTC_to_Pi = QtWidgets.QAction(MainWindow)
        self.actionSync_Time_RTC_to_Pi.setObjectName("actionSync_Time_RTC_to_Pi")
        self.actionSync_Time_Internet_to_Pi_RTC = QtWidgets.QAction(MainWindow)
        self.actionSync_Time_Internet_to_Pi_RTC.setObjectName("actionSync_Time_Internet_to_Pi_RTC")
        self.actionAuto_sync_RTC_to_Pi_on_startup = QtWidgets.QAction(MainWindow)
        self.actionAuto_sync_RTC_to_Pi_on_startup.setCheckable(True)
        self.actionAuto_sync_RTC_to_Pi_on_startup.setChecked(False)
        self.actionAuto_sync_RTC_to_Pi_on_startup.setEnabled(True)
        self.actionAuto_sync_RTC_to_Pi_on_startup.setObjectName("actionAuto_sync_RTC_to_Pi_on_startup")
        self.actionPi_Time = QtWidgets.QAction(MainWindow)
        self.actionPi_Time.setEnabled(False)
        self.actionPi_Time.setObjectName("actionPi_Time")
        ...
        self.menuRTC.addAction(self.actionRTC_Time)
        self.menuRTC.addAction(self.actionPi_Time)
        self.menuRTC.addSeparator()
        self.menuRTC.addAction(self.actionSync_Time_Pi_to_RTC)
        self.menuRTC.addAction(self.actionSync_Time_RTC_to_Pi)
        self.menuRTC.addAction(self.actionSync_Time_Internet_to_Pi_RTC)
        self.menuRTC.addSeparator()
        self.menuRTC.addAction(self.actionAuto_sync_RTC_to_Pi_on_startup)
        self.menubar.addAction(self.menuFile.menuAction())
        self.menubar.addAction(self.menuRTC.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.timeType.setItemText(0, _translate("MainWindow", "OFF"))
        self.timeType.setItemText(1, _translate("MainWindow", "Timeset"))
        self.timeType.setItemText(2, _translate("MainWindow", "Circleset"))
        self.timeReapeat.setText(_translate("MainWindow", "Repeat"))
        self.clockMsg.setText(_translate("MainWindow", "Repeat on Mon, Thu, Sun"))
        self.menuFile.setTitle(_translate("MainWindow", "File"))
        self.menuHelp.setTitle(_translate("MainWindow", "Help"))
        self.menuRTC.setTitle(_translate("MainWindow", "Time"))
        ...
        self.actionRTC_Time.setText(_translate("MainWindow", "RTC Time : "))
        self.actionSync_Time_Pi_to_RTC.setText(_translate("MainWindow", "Sync Time (Pi to RTC) "))
        self.actionSync_Time_RTC_to_Pi.setText(_translate("MainWindow", "Sync Time (RTC to Pi)"))
        self.actionSync_Time_Internet_to_Pi_RTC.setText(_translate("MainWindow", "Sync Time (Internet to Pi and RTC)"))
